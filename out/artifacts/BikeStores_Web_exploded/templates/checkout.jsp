    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <!--Shop info-->
                <div class="shop-info">
                    <p>Returning customerEntity? <a href="#">Click here to login</a></p>
                ...
                <form>
                    <div class="shop-billing-fields">
                        ...
                        <p class="form-row">
                            ...
                            <input type="text" class="input-text " name="company_name" id="company_name" placeholder=""
                                   value="">
                        </p>
                        <p class="form-row">
                        ...
                        <div class="clear"></div>
                        <p class="form-row create-accountEntity">
                            <input class="createaccount" id="createaccount" type="checkbox" name="createaccount"
                                   value="1"> <label for="createaccount" class="checkbox">Create an accountEntity?</label>
                        </p>
                        ...
                        <ul class="payment_methods methods">
                            <li class="payment_method_bacs">
                                ...
                                <div class="payment_box payment_method_bacs">
                                    <p>Make your payment directly into our bank accountEntity. Please use your Order ID as the
