    ...
    <div class="navbar-right">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user-menu">
          ...
          >
            <img
                    src="<c:url value="/static/images/say.jpg"/>"
                    class="user-image"
                    alt="User Image"
            />
            <span class="d-none d-lg-inline-block">${sessionScope.account.customer.name}</span>
          </button>
          <ul class="dropdown-menu dropdown-menu-right">
            <!-- User image -->
            <li class="dropdown-header">
              ...
              <div class="d-inline-block">
                ${sessionScope.account.customer.name} <small class="pt-1">${sessionScope.account.customer.email}</small>
              </div>
            </li>
            <li>
              <a href="profile.html">
